...
exports.updtateProject = updtateProject;
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            id = req.params.id; //requistar parametros para buscar

            _context3.next = 3;
            return _Project["default"].findOne({
              where: {
                id: id // criar uma variavel para salvar a busca
...
function updtateProject(_x9, _x10) {
  return _updtateProject.apply(this, arguments);
}

function _updtateProject() {
  _updtateProject = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(req, res) {
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            id = req.params.id; // vai encontra o ID

            _req$body2 = req.body, name = _req$body2.name, priority = _req$body2.priority, description = _req$body2.description, deliverydate = _req$body2.deliverydate; // vai pegar nova info
